...
public class RegistrationLogServiceUtil {
	...
	private static ServiceTracker
		<RegistrationLogService, RegistrationLogService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(RegistrationLogService.class);

		ServiceTracker<RegistrationLogService, RegistrationLogService>
			serviceTracker =
				new ServiceTracker
					<RegistrationLogService, RegistrationLogService>(
						bundle.getBundleContext(), RegistrationLogService.class,
						null);
